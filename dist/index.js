...
exports.easInfo = void 0;
const util_1 = __importDefault(__nccwpck_require__(669));
const exec = util_1.default.promisify(__nccwpck_require__(129).exec);
function easInfo(appVersion) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { stdout, stderr } = yield exec(`eas build:list --appVersion=${appVersion} --json`);
...
exports.easInfo = easInfo;
function prepare(stdout) {
    try {
        const response = JSON.parse(stdout);
        return response.reduce((acc, build) => {
            if (build.status !== 'CANCELED') {
                const buildLink = getBuildUrl(build.project.ownerAccount.name, build.project.slug, build.id);
...
const getBuildUrl = (owner, projectSlug, buildId) => `https://expo.dev/accounts/${owner}/projects/${projectSlug}/builds/${buildId}`;
...
const eas_1 = __nccwpck_require__(314);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const result = yield (0, eas_1.easInfo)(appVersion);
            if (result !== null) {
